...
public class TeamMember {
     ...
     * @param teamId
     */
    public TeamMember(Integer id, String name, String profilePic, Object birthDate, Integer champsNo, Integer universityId, Integer goalsNo, Integer teamId, String createdAt, String updatedAt, Integer position) {
        super();
        this.id = id;
        this.name = name;
