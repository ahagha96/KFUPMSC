...
public class HomeMatch {
     ...
     * @param roundId
     */
    public HomeMatch(Integer id, String createdAt, String updatedAt, Integer firstTeam, Integer secondTeam, Object firstTeamDescription, Object secondTeamDescription, Integer firstTeamGoals, Integer secondTeamGoals, Integer isFinished, String stadium, Integer roundId, String date, Object pointsCounted, Integer championshipId) {
        super();
        this.id = id;
