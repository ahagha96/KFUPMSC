...
public class BestPlayer {
     ...
     * @param teamId
     */
    public BestPlayer(Integer id, String name, String profilePic, Object birthDate, Integer champsNo, Integer universityId, Integer goalsNo, Integer teamId, String createdAt, String updatedAt, Object position) {
        super();
        this.id = id;
        this.name = name;
